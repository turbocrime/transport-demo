...
import { SayRequest, SayResponse } from "@buf/bufbuild_eliza.bufbuild_es/buf/connect/demo/eliza/v1/eliza_pb";

chrome.runtime.onInstalled.addListener(() => console.log("Background installed"));
chrome.tabs.onCreated.addListener((tab) => console.log('Background detected tab creation', tab));
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => console.log('Background detected tab update', tabId, changeInfo, tab));
